                    ...
                    <form class="apply-form" action="apply.php" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-11">
                                ...
                                <input type="datetime-local" id="end" class="form-control" class="end" name="endTime">
                                <!-- <input type="text" value="<?php echo date()?>" class="form-control" id="start" name="startTime" required> -->
    ...
    <script>
        ...
        <script>
            $(document).ready(function(){
                ...
                var day = dt.getDate();
                var time = '21:30';
                var end = dt.getFullYear() + '-' + ((''+month).length<2 ? '0' : '') + month + '-' + ((''+day).length<2 ? '0' : '') + day + 'T'+  time; 

                $("#end").val(end); //for auto select today's date and 6:30pm.
            })
        </script>
