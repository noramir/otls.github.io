...
<head>
	...
	<link rel="stylesheet" type="text/css" href="style/admin-dashboard-style.css">
	<meta charset="utf-8"/>
        ...
        <div class="container">
            <div class="row">
              ...
              <div class="buttons col-8">
                    <div class="row col-12">
                        <a href="admin-panel.php?pending-application-list" class="btn btn-dark btn-block">Pending List</a>
                        <a href="#" class="btn btn-dark btn-block" name="view-submit">Overtime Log</a> 
                    </div>
                </div>
            </div>
        </div>
